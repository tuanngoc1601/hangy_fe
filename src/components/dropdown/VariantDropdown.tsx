...
const VariantDropdown = ({
  ...
  return (
    <Dropdown setIsOpenDropdown={setIsOpen}>
      <div className="absolute top-full -left-1/2 z-40 border bg-white p-4 rounded-sm shadow-sm flex flex-col gap-4 cursor-default transition">
